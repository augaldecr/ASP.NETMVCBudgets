...
namespace ASP.NETMVCBudgets.Servicios
{
    public interface IRepositorioTransacciones
    {
        ...
        Task<IEnumerable<ResultadoObtenerPorMes>> ObtenerPorMes(int usuarioId, int anho);
    ...
    public class RepositorioTransacciones : IRepositorioTransacciones
    {
            ...
            int anho)
        {
            ...
            INNER JOIN Categorias cat
            ON cat.Id = Transacciones.CategoriaId
            WHERE Transacciones.UsuarioId = @usuarioId AND YEAR(FechaTransaccion) = @anho
            GROUP BY Month(FechaTransaccion), cat.TipoOperacionId", new { usuarioId, anho });
        }
